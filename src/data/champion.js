export let ChampionData = {
	aatrox: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'AatroxQ',
            note: "Q1, 1.50x damage on sweetspot",
            skill: 1,
            cd: [[14,12,10,8,6], "single"],
            cast: 0.6
          },
          {
            base: [12.5,37.5,62.5,87.5,112.5],
            type: "damage",
            damage: "physical",
            ad: [75,81.25,87.5,93.75,100],
            ap: 0,
            bAd: 0,
            rname: 'AatroxQ',
            note: "Q2, 1.50x damage on sweetspot",
            skill: 1,
            cast: 0.6
          },
          {
            base: [15,45,75,105,135],
            type: "damage",
            damage: "physical",
            ad: [90,97.5,105,112.5,120],
            ap: 0,
            bAd: 0,
            rname: 'AatroxQ',
            note: "Q3, 1.50x damage on sweetspot",
            skill: 1,
            cast: 0.6
          },
          {
            ...
            bAd: 0,
            rname: 'AatroxW',
            note: "2.0x damage if target is pulled",
            skill: 2,
            cd: [[26,23,20,17,14], "single"],
            cast: 0.25
          },
          {
            base: [0],
    ...
    ahri: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'AhriSeduce',
       		note: "Enemies hit by this ability takes 1.2x damage.",
            skill: 3,
            cd: [[12], "single"],
            cast: 0.25
          },
    ...
    akali: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'AkaliR',
            note: "Second cast, min damage, deals 20% more per 7% target missing health (upto 200% bonus damage)",
            skill: 4,
            cd: [[0], "single"],
            cast: 0.25
          },
    ...
    alistar: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'AlistarE',
            note: "bonus damage on next auto",
            skill: 3
          },
          {
            base: [0],
    ...
    ashe: {
        ...
        abilities: [
          ...
          },
          {
            ...
            note: "skill can hold up to 2 charges",
            skill: 3,
            cd: [[90,80,70,60,50], "recharge"],
            cast: 0.25
          },
          {
            base: [200,400,600],
    ...
    aurelionsol: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'AurelionSolW',
            note: "active, enhanced damage",
            skill: 2,
            cd: [[8,6.5,5,3.5,2], "single"],
            cast: 0.25
          },
          {
            base: [5,10,15,20,25],
            ...
            bAd: 0,
            rname: 'AurelionSolW',
            note: "damage added to passive orbit",
            skill: 2,
            cast: 0.25
          },
          {
        ...
        abilities: [
          {
            ...
            ap: 15,
            damage: "magical",
            note: "passive, deals more damage the longer the game is ((4 * multiplier) * gameminutes) calc assumes 0 minutes.",
            skill: 0
          },
          {
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'AzirW',
            note: "solidier's basic attack, multiple soliders deal 0.25x damage, max 2 charges",
            skill: 2,
            cd: [[8,7.5,7,6.5,6], "recharge"],
            cast: 0.25
          },
          {
        ...
        abilities: [
          {
            ...
            rname: "Bard_Passive",
            ap: 30,
            note: "passive | deals +12 damage per 5 chimes",
            damage: "magical",
            skill: 0
          },
          {
    ...
    caitlyn: {
        ...
        abilities: [
          ...
          },
          {
            ...
            note: "bonus damage, max 3-5 charges based on skill level",
            skill: 2,
            cast: 0.25,
            cd: [[30,25.5,21,16.5,12], "recharge"],
          },
          {
            base: [70,110,150,190,230],
            damage: 'magical',
    ...
    camille: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: [20,25,30,35,40],
            rname: 'CamilleQ',
            note: "first active bonus damage, second cast deals 2.0x damage and 40+4%(cam level - 1) is dealt as true damage",
            skill: 1,
            cd: [[9,8.25,7.5,6.75,6], "single"],
          },
          {
    ...
    diana: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'DianaOrbs',
            note: "2x shield value if all 3 orbs were used",
            skill: 2
          },
          {
    ...
    drmundo: {
        name: 'drMundo',
        // NOTE THIS CHAMPION HAS BEEN REWORKED
        masochism: false,
        lv: 1,
        baseHp: 583,
        hp: 583,
        ...
        abilities: [
          ...
          },
          {
            ...
            rname: "Masochism",
            buff: "masochism",
            note: "bonus damage on next basic attack",
            skill: 3,
            cd: [[6,5.5,5,4.5,4], "single"],
          },
          {
            base: [0],
            damage: 'none',
    ...
    fiddlesticks: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 60,
            rname: 'FiddleSticksW',
            note: "per tick, 0.25s intervals, 2s duration",
            cd: [[10,9.5,9,8.5,8], "dot", [0.25]],
            skill: 2
          },
          {
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'FiddleSticksR',
            cd: [[140,110,80], "dot", [0.25]],
            note: "per tick, 0.25s intervals, 5s duration",
            skill: 4
          }
        ],
    ...
    gangplank: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: "GangplankE",
            cd: [[18,16,14,12,10], "recharge"],
            note: "bonus damage, does not calc damage from skill/attack used to trigger",
            skill: 3
          },
          {
            base: [40,70,100],
    ...
    garen: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: "GarenE",
            note: "1.25x damage if target is the nearest enemy, non crit",
            cd: [[9], "single"],
            skill: 3
          },
          {
    ...
    jayce: {
        ...
        abilities: [
          ...
          },
          {
            ...
            note: "Ranged W",
            cd: [[13,11.4,9.8,8.2,6.6,5], "single"],
          },
          {
            base: [0,0,0,0,0],
            damage: 'magical',
    ...
    karma: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'KarmaSolKimShield',
            note: "bonus shield, applied on top of base shield",
            skill: 4
          },
        ],
    ...
    kennen: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: [60,70,80,90,100],
            rname: 'KennenBringTheLight',
            note: "enhanced auto bonus damage",
            skill: 2
          },
          {
            base: [80,120,160,200,240],
    ...
    leblanc: {
        ...
        abilities: [
          ...
          },
          {
            ...
            rname: "LeblancE",
            note: "initial damage",
            cd: [[14,13.25,12.5,11.75,11], "single"],
            skill: 3
          },
          {
            base: [80,120,160,200,240],
    ...
    lissandra: {
        ...
        abilities: [
          ...
          },
          {
            ...
            ap: 30,
            bAd: 0,
            note: "min heal, max 2.0x 1% increase per missing hp",
            rname: 'LissandraR',
            skill: 4
          }
        ],
    ...
    lux: {
        ...
        abilities: [
          ...
          {
            base: [40,65,85,105,125],
            type: 'shield',
            ad: 0,
            ap: 35,
            bAd: 0,
            note: "shield, 2.0x if target was hit by both parts",
    ...
    malzahar: {
        ...
        abilities: [
          ...
          },
          {
            ...
            cd: [[140,110,80], "single"],
            skill: 4,
            note: "damage from skill itself, DOT"
          },
          {
            base: [0,0,0],
            damage: 'magical',
    ...
    pantheon: {
        ...
        abilities: [
          ...
          },
          {
            ...
            skill: 1,
            cd: [[13,11.75,10.5,9.25,8], "single"],
          },
          {
            lvScale: [20,240],
            base: [70,100,130,160,190],
          ...
          },
          {
            ...
            bAd: 0,
            rname: "PantheonE",
            note: "shield slam damage | deals up to 1 basic attack(non-crit) for channel",
            cd: [[22,20.5,19,17.5,16], "single"],
            skill: 3
          },
          {
    ...
    rakan: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: "RakanE",
            note: "this ability can be recasted",
            cd: [[20,18,16,14,12], "single"],
            skill: 3
          },
          {
    ...
    rell: {
        ...
        abilities: [
          ...
          },
          {
            ...
            rname: "RellE",
            skill: 3,
            cd: [[18,16.25,14.5,12.75,11], "single"],
          },
          {
            base: [15,25,35],
            damage: 'magical',
    ...
    rumble: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'RumbleShield',
            note: "shield, enhanced applies 1.5x shield",
            cd: [[6], "single"],
            skill: 2
          },
          {
    ...
    ryze: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bmana: 2,
            rname: "RyzeE",
            cd: [[3.25,3,2.75,2.5,2.25], "single"],
            note: "does not calc mana scale",
            skill: 3
          },
          {
    ...
    shaco: {
        ...
        abilities: [
          ...
          },
          {
            ...
            ap: 9,
            bAd: 0,
            note: "damage doubled against single target",
            rname: 'JackInTheBox',
            cd: [[16], "single"],
            skill: 2
          },
    ...
    soraka: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 0,
            rname: 'SorakaR',
            note: "heal, restores 1.5x on champions <40% health",
            cd: [[160,145,130], "single"],
            skill: 4
          }
        ],
    ...
    urgot: {
        ...
        abilities: [
          ...
          },
          {
            ...
            damage: 'physical',
            type: 'damage',
            ad: [20,23.5,27,30.5,34],
            cd: [[12,9,6,3,0], "single"],
            ap: 0,
            bAd: 0,
            rname: 'UrgotW',
    ...
    yasuo: {
        ...
        abilities: [
          ...
          },
          {
            ...
            bAd: 20,
            rname: "YasuoE",
            cd: [[0.5,0.4,0.3,0.2,0.1], "single", "static"],
            skill: 3
          },
          {
            base: [200,350,500],
