	...
	return (
		<section className="rune-section">
			...
			<div className="rune-keystones-row">
				<div className={`keystone ${currentrunes.inspiration.key1  !== false ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'key1')}>
				...
				<div className={`keystone ${currentrunes.inspiration.key2  !== false ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'key2')}>
					<img className="keystone-image" src={Key2} alt="Inspiration keystone spellbook"/>
					<p className="keystone-name">Spellbook</p>
				</div>
				<div className={`keystone ${currentrunes.inspiration.key3  !== false ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'key3')}>
			...
			<div className="minor-runes-row">
				<div className={`minor ${currentrunes.inspiration.node1 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node1')}>
					<img className="minor-image" src={Minor1} alt="Inspiration node hextech flashtraption"/>
					<p className="minor-name">Flashtraption</p>
				</div>
				<div className={`minor ${currentrunes.inspiration.node2 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node2')}>
					<img className="minor-image" src={Minor2} alt="Inspiration node magical footwear"/>
					<p className="minor-name">Magical Footwear</p>
				</div>
				<div className={`minor ${currentrunes.inspiration.node3 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node3')}>
					<img className="minor-image" src={Minor3} alt="Inspiration node perfect timing"/>
					<p className="minor-name">Perfect Timing</p>
				</div>
			</div>
			<div className="minor-runes-row">
				<div className={`minor ${currentrunes.inspiration.node4 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node4')}>
					<img className="minor-image" src={Minor4} alt="Inspiration node future's market"/>
					<p className="minor-name">Future's Market</p>
				</div>
				<div className={`minor ${currentrunes.inspiration.node5 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node5')}>
					<img className="minor-image" src={Minor5} alt="Inspiration node minion dematerializer"/>
					<p className="minor-name">Dematerializer</p>
				</div>
				<div className={`minor ${currentrunes.inspiration.node6 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node6')}>
					<img className="minor-image" src={Minor6} alt="Inspiration node biscuit delivery"/>
					<p className="minor-name">Biscuit Delivery</p>
				</div>
			</div>
			<div className="minor-runes-row">
				<div className={`minor ${currentrunes.inspiration.node7 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node7')}>
					<img className="minor-image" src={Minor7} alt="Inspiration node cosmic insight"/>
					<p className="minor-name">Cosmic Insight</p>
				</div>
				<div className={`minor ${currentrunes.inspiration.node8 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node8')}>
					<img className="minor-image" src={Minor8} alt="Inspiration node approach velocity"/>
					<p className="minor-name">Approach Velocity</p>
				</div>
				<div className={`minor ${currentrunes.inspiration.node9 !== false  ? "rune-active" : "rune-inactive"}`} onClick={() => updateRuneStatus('inspiration', 'node9')}>
